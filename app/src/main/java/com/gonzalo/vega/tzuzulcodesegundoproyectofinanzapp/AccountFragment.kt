...
import com.gonzalo.vega.tzuzulcodesegundoproyectofinanzapp.viewmodels.factories.AccountViewModelFactory
...
class AccountFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.navigateToCard.observe(viewLifecycleOwner, Observer {
            it?.let {
                val action =
                    AccountFragmentDirections.actionAccountFragmentToCardDetailsFragment(it)
